...
test_that("cols getting dropped", {
  ...
  expect_equal(eff1$`disp = 90`$Margin, c(), tolerance = 0.0001)
  expect_equal(eff1$`disp = 90`$Standard.Error, c(), 
               tolerance = 0.0001)
  expect_equal(eff1$`disp = 90`$P.Value, c(), tolerance = 0.0001)
  expect_equal(eff1$`disp = 425`$Margin, c(), tolerance = 0.0001)
  expect_equal(eff1$`disp = 425`$Standard.Error, c(), 
               tolerance = 0.0001)
  expect_equal(eff1$`disp = 425`$P.Value, c(), tolerance = 0.0001)
