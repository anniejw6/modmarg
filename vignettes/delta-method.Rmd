...
\ldots and $\nabla {\hat{y}_{\tau = t}}$ is the derivative of $\hat{y}_{\tau = t}$ with respect to each of the $\beta$ parameters. Going back to our function from before, let's start with the coefficient on treatment, $\beta_1$.
