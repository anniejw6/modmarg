...
of asymptotically normal random variables with known variance. In this case, the delta method takes 
...
of random variable $r$, $\text{Var}(a \cdot r)$ is $a^2 \cdot b$. The matrix analog of $a^2 \cdot \text{Var}(b)$
is $ABA^T$.]
...
\begin{align*}
\frac{\partial}{\partial \beta_1} g(P(X\beta)) 
